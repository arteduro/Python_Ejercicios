#Método startswth():se utiliza para comprobar si una cadena de caracteres comienza con una subcadena en particular.
#Método endswth():se utiliza para comprobar si una cadena de caracteres termina con una subcadena en particular.
